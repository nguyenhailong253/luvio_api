...
class UserProfileCreateOrUpdateSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data: dict) -> UserProfile:
        ...
        Profile URI by default is generated by combining username and profile id
        """
        self._is_account_already_has_profile(
            validated_data["account"], validated_data["profile_type"]  # type: ignore[arg-type]
        )
        profile = UserProfile.objects.create(**validated_data)
        profile.profile_uri = f"{profile.account.username}-{profile.id}"
        profile.save()
        return profile
    ...
    def update(self, instance: UserProfile, validated_data: dict) -> UserProfile:
        ...
        instance.profile_uri = validated_data["profile_uri"]
        instance.save()
        return instance
